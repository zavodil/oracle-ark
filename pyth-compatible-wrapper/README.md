...
NEAR smart contract that implements the [Pyth receiver contract](https://github.com/pyth-network/pyth-crosschain/tree/main/target_chains/near/receiver) API, but internally uses [Oracle-Ark](https://github.com/NearDeFi/price-oracle) (`priceoracle.near`) for price data.
